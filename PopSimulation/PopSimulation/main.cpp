...
double lambdaPolicy[3] = { 1.92 , 0.54 , 0.54 };
double lambdaMove[2] = { 0.0019669, 0.0019669 }; // VERIFIED! 0.0019669
double lambdaSmarter[2] = { 0.000578613, 0.000578613 }; // VERIFIED! 0.000578613
double etaAge[100][3];
